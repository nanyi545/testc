...
//            mediacodec  中间联系人      dsp芯片   帧
            ...
            handler.post(new Runnable() {
                @Override
                public void run() {
                    Toast.makeText(VideoChatPush.getInstance(),"h265 ok",Toast.LENGTH_SHORT).show();
                }
            });
            ...
            handler.post(new Runnable() {
                @Override
                public void run() {
                    Toast.makeText(VideoChatPush.getInstance(),"h265 fail"+Log.getStackTraceString(e),Toast.LENGTH_SHORT).show();
                }
            });
