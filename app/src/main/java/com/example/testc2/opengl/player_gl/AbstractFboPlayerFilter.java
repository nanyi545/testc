...
import com.example.testc2.opengl.camera_gl.AbstractFilter;

import java.io.File;

import static android.opengl.GLES11Ext.GL_TEXTURE_EXTERNAL_OES;

public class AbstractFboPlayerFilter extends AbstractPlayerFilter {
//    cpu
    int[] frameBuffer;
    int[] frameTextures;
    public AbstractFboPlayerFilter(Context context, int vertexShaderId, int fragmentShaderId,  SurfaceTexture.OnFrameAvailableListener onFrameAvailableListener) {
        ...
        public void handleMessage(@NonNull Message msg) {
            ...
            switch (msg.what) {
                case 111:
                    ...
                    h264Player = new H264Player(context,
                            f.getAbsolutePath(),
                            new Surface(st));
                    h264Player.play();
...
//            GLES20.glBindTexture(GL_TEXTURE_EXTERNAL_OES, frameTextures[i]);
...
//            GLES20.glBindTexture(GL_TEXTURE_EXTERNAL_OES, 0);
        ...
        //  --> SurfaceText
        int mTextureID = frameTextures[0];
