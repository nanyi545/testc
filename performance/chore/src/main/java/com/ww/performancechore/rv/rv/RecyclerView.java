...
//        }
    ...
    protected void onMeasure(int widthSpec, int heightSpec) {
        ...
        if (mLayout.isAutoMeasureEnabled()) {
            ...
            Logger.log(Logger.RECYCLERVIEW_TAG, "  widthMode:" + Logger.getModeStr(widthMode) + "  heightMode:" + Logger.getModeStr(heightMode));
    ...
    void dispatchLayout() {
        ...
        Logger.log(Logger.RECYCLERVIEW_TAG, "mState.mIsMeasuring:" + mState.mIsMeasuring + "  mState.mLayoutStep:" + mState.mLayoutStep);
    ...
    private void dispatchLayoutStep1() {
        Logger.log(Logger.RECYCLERVIEW_TAG, "---dispatchLayoutStep1---" );
        ...
        mState.mItemCount = mAdapter.getItemCount();
        /**
         * ww: first time call this, you get [-1,-1] .....
         */
    ...
    private void dispatchLayoutStep2() {
        Logger.log(Logger.RECYCLERVIEW_TAG, "---dispatchLayoutStep2---" );
        startInterceptRequestLayout();
        onEnterLayoutOrScroll();
